...
if(su==0)
{
    ...
    char arr3[300]=" && make -j5 && make install && mkdir qemu-binary-demo && git clone 'https://gitee.com/xc1984759471/qemu-binary-demo.git';cd qemu-binary-demo;rm -rf /usr/local/bin/uninstall_qemu;cat uninstall >> /usr/local/bin/uninstall_qemu ; chmod 777 /usr/local/bin/uninstall_qemu  ; cd ../..;rm -rf qemu'";
...
char arr42[100]=" qemu ; rm -rf qemu.tar.xz";
	...
	if(loc==0)
            ...
            printf("Update: Add English language translation\n");
