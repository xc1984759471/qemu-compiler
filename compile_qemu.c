...
{
    system("wget -O get-qemu.py https://raw.kkgithub.com/xc1984759471/qemu-compiler/main/get-qemu.py || wget -O get-qemu.py https://raw.githubusercontent.com/xc1984759471/qemu-compiler/main/get-qemu.py");
    if(arg==0)
	{
